...
## Changes Made
1. Updated `.reasonCard` background to `rgba(255, 255, 255, 0.05)` in light mode and `rgba(30, 41, 59, 0.6)` in dark mode
2. Updated `.weekCard` background to `rgba(255, 255, 255, 0.05)` in light mode and `rgba(30, 41, 59, 0.6)` in dark mode
